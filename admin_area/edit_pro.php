...
<form action="" method="post"  enctype="multipart/form-data">
    <table align="center" width="795" border="2" bgcolor=#0D77B1>
        ...
        <tr>
            ...
            <td><textarea name="product_desc" id="" cols="70" rows="25"> <?php echo $pro_desc; ?></textarea></td>
        </tr>
...
if(isset($_POST['update_product'])){
    ...
    // строка выражение
    echo $update_product = "update products set product_cat='$product_cat', product_brand='$product_brand', product_title='$product_title',
     product_price='$product_price', product_desc='$product_desc', 
     product_image='$product_image', product_keywords='$product_keywords'
